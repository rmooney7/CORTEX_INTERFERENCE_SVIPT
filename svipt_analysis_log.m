...
StartDirectory = cd('/Volumes/RONAN_USB/Celnik_Bastian_Postdoc/Experiments/NML/NML_EI/Data/Behavior/SVIPT_analysis');
...
%% SVIPT INFO
gate4_low = 0.169-0.0155;
gate4_high = 0.264+0.0155;
gate4_mid = ((gate4_high-gate4_low)/2)+gate4_low;

gate1_low = 0.359-0.0155;
gate1_high = 0.435+0.0155;
gate1_mid = ((gate1_high-gate1_low)/2)+gate1_low;

gate3_low = 0.551-0.0155;
gate3_high = 0.627+0.0155;
gate3_mid = ((gate3_high-gate3_low)/2)+gate3_low;

gate5_low = 0.715-0.03;
gate5_high = 0.715+0.03;

gate2_low = 0.831-0.0155;
gate2_high = 0.929+0.0155;
...
Save_dir = sprintf ('/Volumes/RONAN_USB/Celnik_Bastian_Postdoc/Experiments/NML/NML_EI/Data/Behavior/SVIPT_analysis/Output'); % Save location for output file
...
for s = 1:length(Subject) % Getting all participants
    ...
    DirectoryPathName2 = sprintf ('/Volumes/RONAN_USB/Celnik_Bastian_Postdoc/Experiments/NML/NML_EI/Data/Behavior/SVIPT_analysis/Data/%s/%s',Folder_Name,Force_Folder);
